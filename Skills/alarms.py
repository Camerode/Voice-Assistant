...
def open_alarms():
    try:
        ...
        print("An error has occurred in the open_alarms command, output has been sent to errors.log")
        speak("An error has occurred in the open_alarms command, output has been sent to errors.log")
        with open("Skills/CoreFiles/errors.log", "a") as f:
            f.write("open_alarms: " + str(e) + "\n")

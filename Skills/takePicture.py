...
def take_picture_and_save():
    try:
        ...
        print("An error has occurred in the takePicture command, output has been sent to errors.log")
        speak("An error has occurred in the takePicture command, output has been sent to errors.log")
        with open("Skills/CoreFiles/errors.log", "a") as f:
            f.write("take_picture_and_save: " + str(e) + "\n")